...
<li>add support of Spark (meanwhile you can install it as we <a href="https://github.com/AIDesigners/AIDesigners.github.io-cluster_setup">described</a> previously) into Gul so it can natively run on scale.</li>
